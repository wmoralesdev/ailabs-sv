...
function SlidesPartnerLogoCell({ name }: { name: string }) {
  const column = (mark: ReactNode) => (
    <div className="flex min-w-0 flex-col items-center gap-3 md:gap-4">
      <div className="flex min-h-[4rem] w-full items-center justify-center px-0.5 md:min-h-[5rem]">
        {mark}
      </div>
    ...
    return column(
      <>
        <img
          ...
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.cursorLight)}
        />
        <img
          src={CURSOR_PARTNER_IMG.dark}
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.cursorDark)}
        />
      </>,
    );
  }
    ...
    return column(
      <>
        <img
          ...
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.v0Light)}
        />
        <img
  ...
  if (name === "n8n") {
    return column(
      <img
        src={N8N_PARTNER_IMG.mark}
        alt=""
        className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.n8n)}
      />,
    );
  }
  if (name === "OpenAI") {
    return column(
      <>
        <img
          src={OPENAI_PARTNER_IMG.light}
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.openaiLight)}
        />
        <img
          src={OPENAI_PARTNER_IMG.dark}
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.openaiDark)}
        />
      </>,
    );
  }
  if (name === "Vercel") {
    return column(
      <>
        <img
          src={VERCEL_PARTNER_IMG.light}
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.vercelLight)}
        />
        <img
          src={VERCEL_PARTNER_IMG.dark}
          alt=""
          className={cn(slidesPartnerMarkClasses.base, slidesPartnerMarkClasses.vercelDark)}
        />
      </>,
    );
  }
  ...
  return (
    <div className="flex min-w-0 flex-col items-center justify-center gap-3">
      <p className="text-center font-display text-lg font-semibold tracking-tight text-foreground md:text-xl">
        {name}
      </p>
    </div>
  );
...
function BrandStudentsPartnersSlide() {
  const { t } = useI18n();
  const { partnersSlide } = t.slidesBrandStudentsDeck;

  return (
    <SlideLayout eyebrow={partnersSlide.eyebrow} title={partnersSlide.title} staggerChildren>
      <p className="max-w-3xl text-lg leading-relaxed text-muted-foreground">
        <SlidesBrandText text={partnersSlide.intro} />
      </p>
      <div className="grid w-full grid-cols-5 gap-2 md:gap-4 lg:gap-6">
        {partnersSlide.companies.map((name) => (
          <SlidesPartnerLogoCell key={name} name={name} />
        ))}
      </div>
    </SlideLayout>
  );
...
export const brandStudentsDeckSlides = [
  BrandCoverSlide,
  BrandWhoWeAreSlide,
  BrandOverviewSlide,
  BrandCommunitySlide,
  BrandPastEventsSlide,
  BrandStudentsPartnersSlide,
  BrandFoundersSlide,
  BrandContactSlide,
  BrandThanksSlide,
] as const;
