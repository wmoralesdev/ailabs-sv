    ...
    <>
      ...
      <div className="bg-background text-foreground selection:bg-primary selection:text-primary-foreground motion-safe:animate-page-in flex min-h-dvh flex-col overflow-x-hidden font-sans">
        <main className="flex flex-1 flex-col pt-20 md:pt-24">
          <section className="border-border relative flex w-full flex-1 items-center justify-center overflow-hidden border-b py-12 md:py-16">
            <AnimatedGrid className="opacity-45" />
            ...
            <div className="relative z-10 container mx-auto flex justify-center px-6">
              <div className="mx-auto w-full max-w-md">
                <ClerkLoading>
                  <div
                    className={`${outerCardClass} flex min-h-[360px] flex-col p-6 md:p-8`}
                  >
