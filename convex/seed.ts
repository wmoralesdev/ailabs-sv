...
const LAB_CARDS_SEED: Array<{
  ...
  },
  {
    ...
    description: {
      es: 'Tres prototipos que fallaron, y por qué importan más que los que funcionaron.',
      en: 'Three prototypes that failed, and why they matter more than the ones that worked.',
    },
