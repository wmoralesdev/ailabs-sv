...
import { assertNotMonthArchiveSlug } from './lib/event/slug'
...
export const patchEvent = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.photoAlbumUrl !== undefined)
      patch.photoAlbumUrl = args.photoAlbumUrl
    ...
    const startAt = args.startAt !== undefined ? args.startAt : existing.startAt
